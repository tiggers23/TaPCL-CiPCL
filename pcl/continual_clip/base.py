...
class _BaseScenario(abc.ABC):
    ...
    def __getitem__(self, task_index: Union[int, slice]):
        ...
        x, y, cap, t, _, data_indexes = self._select_data_by_task(task_index)
    ...
    def _select_data_by_task(
        ...
        x, y, cap, t = self.dataset  # type: ignore
        ...
        return selected_x, selected_y, selected_cap, selected_t, task_index, data_indexes
